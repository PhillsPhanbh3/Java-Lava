...
module.exports = {
    ...
    .addSubcommand(command => command.setName('sexual-content').setDescription('Block profanity and sexual content')),
        ...
        if (!interaction.member.permissions.has(PermissionsBitField.Flags.Administrator)) return await interaction.reply({ content: 'you do not have the required permission **ADMINISTRATOR** to set up the discord automod system within this server', ephermal: true})
            ...
            switch (sub) {
                ...
                const rule = await guild.autoModerationRules.create({
                    name: 'Block profanity and sexual content by Java Lava',
                ...
                setTimeout(async () => {
                    ...
                    .setColor("Blurple")
                    .setDescription('<:Verified:1320110619705475072> Your automod rule has been created, all messages containing profanity and sexual content will be blocked by Java Lava')
